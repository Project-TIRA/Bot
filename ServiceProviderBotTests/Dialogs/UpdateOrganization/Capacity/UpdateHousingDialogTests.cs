...
namespace SearchProviderBotTests.Dialogs.UpdateOrganization.Capacity
{
    public class UpdateHousingDialogTests : DialogTestBase
    {
        ...
        public async Task Update()
        {
            ...
            var data = await TestHelpers.CreateHousingData(this.api, user.Id, service.Id);
        ...
        public async Task NoWaitlist()
        {
            ...
            var service = await TestHelpers.CreateService<HousingData>(this.api, organization.Id);
            var data = await TestHelpers.CreateHousingData(this.api, user.Id, service.Id, hasWaitlist: false);
