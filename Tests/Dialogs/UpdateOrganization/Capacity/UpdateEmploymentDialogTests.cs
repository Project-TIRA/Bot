...
namespace Tests.Dialogs.UpdateOrganization.Capacity
{
    public class UpdateEmploymentDialogTests : DialogTestBase
    {
        ...
        public async Task Update()
        {
            ...
            var data = await TestHelpers.CreatEmploymentData(this.api, user.Id, service.Id, true, true, TestHelpers.DefaultTotal, TestHelpers.DefaultTotal, TestHelpers.DefaultTotal, TestHelpers.DefaultTotal);
            ...
            var resultData = await this.api.GetLatestServiceData<EmploymentData>(this.turnContext, true);
        ...
        public async Task NoWaitlist()
        {
            ...
            var service = await TestHelpers.CreateService<EmploymentData>(this.api, organization.Id);
            var data = await TestHelpers.CreatEmploymentData(this.api, user.Id, service.Id, true, false, TestHelpers.DefaultTotal, TestHelpers.DefaultTotal, TestHelpers.DefaultTotal, TestHelpers.DefaultTotal);
