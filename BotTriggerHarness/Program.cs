...
namespace BotTriggerHarness
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var connectionString = "Server=(LocalDb)\\MSSQLLocalDB;initial catalog=ProjectTira;integrated security=True;MultipleActiveResultSets=True;App=EntityFramework";
